    ...
    return (
        <li className="flex gap-3">
            ...
            >
                ...
                {showTooltip && (
                    <span className="tooltip-text bg-black text-white p-2 rounded-lg absolute bottom-full left-1/2 transform -translate-x-1/2 -translate-y-2">
