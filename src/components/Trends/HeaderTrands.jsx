                ...
                <ul className=" flex flex-col gap-5">
                    <li className="flex gap-36">
                        <div>
                            ...
                            <p>#SQUID</p>
                            <div className="flex gap-2 text-police">
                                <p>{Accounter}</p>
                                <p>{TitleTweets}</p>
                            </div>
                        </div>
