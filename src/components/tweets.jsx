...
import Tweet from '../components/tweet'; // Ajustez le chemin selon votre structure de fichiers
import tweetsData from '../data/tweets.json'; // Ajustez le chemin selon votre structure de fichiers
